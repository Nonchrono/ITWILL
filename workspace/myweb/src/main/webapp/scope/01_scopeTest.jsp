...
/*
	● [JSP 내장객체]
	- JSP 페이지가 서블릿에서 변환될 때(.class) JSP컨테이너(=Tomcat웹서버)가 자동적으로 제공
...
---------------------------------------------------------------------------------------------------
	...
	3) session		: myweb 프로젝트의 모든 페이지에서 유효 (사용자 개별 접근, 시간 개념 有)
