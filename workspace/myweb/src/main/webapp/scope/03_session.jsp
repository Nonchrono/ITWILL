...
<%
	/*
		...
		- 선언한 세션 변수는 전역적 상태로 유지된다 (즉, 전역변수)
		- 요청한 정보의 상태를 유지하기 위해서
		- 일정 "시간"동안 이벤트가 발생되지 않으면 자동 삭제 (은행 사이트 로그인 시간처럼)
	*/
	
	
	// 세션 내장객체에서 발급해주는 임시 id
	out.print("세션 임시 아이디 : ");
	...
	// 세션변수
	session.setAttribute("s_id", "Nonchrono");
