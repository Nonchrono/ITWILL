	...
	<table class="table">
		...
		<tr>
		   <td colspan="2">
			  ...
			  <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#signUp">회원가입</button>
...
본 약관은 2005. 7. 18. 부터 적용하고, 2004. 10. 11.부터 적용되던 종전의 약관은 본 약관으로 대체합니다. 
			        ...
			        <div class="modal-footer" style="text-align: center; font-size: 16px;">
			        	...
			        	<br><br>
			        	<button onclick="location.href='memberForm.jsp'" id="signup2" class="btn btn-primary" disabled="disabled">회원가입</button> 
			  ...
			  <button onclick="location.href='findIDPW.jsp'" class="btn btn-info btn-lg">아이디 / 비밀번호 찾기</button>
		   </td>
		</tr>
		</table>
</form>
