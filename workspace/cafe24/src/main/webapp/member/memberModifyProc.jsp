...
<%
	...
	String tel = Utility.checkNull(dto.getTel());
...
<tr>
    <th>전화번호</th>
    <td style="text-align: left"><input type="text" name="tel" id="tel" size="15" value="<%=tel%>"></td>
</tr>
<tr>
    <th>우편번호</th>
    <td style="text-align: left">
      <input type="text" name="zipcode" id="zipcode" size="7" value="<%=zipcode%>" readonly>
