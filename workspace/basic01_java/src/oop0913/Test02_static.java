...
public class Test02_static {
	...
	public static void main(String[] args) {
		// static 정적
		// -> 변수 (정적변수, 클래스변수), 함수
		// -> static 메모리 공간에 생성 1번, 소멸도 1번 된다
		// -> new는 heap 공간에 쓰는 것이기 때문에 new 연산자를 이용한 별도의 객체 생성 없이 사용 가능하다
		...
		// -> static 변수와 static 함수는 이미 static 메모리에 값이 올라와있기 때문에
		// -> 별도의 객체 생성을 하지 않고도 바로 접근할 수 있다.
		
		Sawon two = new Sawon("1002", "진달래", 200);
		myTax = two.pay*two.TAX; // 3
		...
		System.out.println(Sawon.SUDANG);	// 추천 표기법
