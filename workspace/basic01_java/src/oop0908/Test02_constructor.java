...
class School {
	...
	// 생성자함수 constructor
	// -> 클래스명과 동일한 함수
	// -> 리턴형이 없다 public void school() {} 주의!! 에러는 안 나지만 오류이다.
...
public class Test02_constructor {
	...
	public static void main(String[] args) {
		...
		// null 비어있는 값
		String a = "";			// 빈 문자열
		String b = null;		// 메모리 할당은 하지 않고 b라는 참조 변수만 선언만 해놓음
		...
		*/
		...
		// 생성자 함수의 전달값은 객체 선언과 동시에 초기값을 전달해주는 역할을 한다
