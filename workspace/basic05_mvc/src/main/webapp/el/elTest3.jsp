...
<%
	...
	application.setAttribute("aver", 400); // 전역변수 (모든페이지에서 유효 + 모든 사용자)
%>
...
--%>
	...
	<!-- EL에서는 page -> request -> session -> application 순서대로 자동으로 검색 -->
	kor : ${kor}<br>
	eng : ${eng}<br>
	mat : ${mat}<br>
	aver : ${aver}<br>
...
%>
	...
	JSP : <%=request.getParameter("uname")%> <!-- null -->
	<br>
